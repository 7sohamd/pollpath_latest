...
import { Plus, Minus, Check, Twitter, Linkedin, Facebook, Instagram, MessageCircle, User, Globe, PenTool, Slack, Github, Dribbble, Crown } from 'lucide-react';
import Button from './ui/Button';
import { FaqItem, PricingTier, RazorpayPaymentData } from '../types';
